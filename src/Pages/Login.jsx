    ...
    <>
      <section className="login-section">
        ...
        <div className="page-padding py-[10rem] flex justify-center">
          ...
          >
            {error ? (
              <p className="text-black bg-[#FAFF00] font-bold text-[1.6rem] px-10 py-5 text-center mb-10">
            ...
            <p className="text-[#ffffffbc] text-[1.4rem] mt-3">
              <span className="text-[#FAFF00]">Test Account</span> -
              test12345@test.com <span className="text-[#FAFF00]"> / </span>
              123456
            </p>
          </form>
        </div>
